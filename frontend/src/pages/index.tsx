...
export function HomeInner() {
  ...
  const showPG = useMemo(() => {
    return Boolean(process.env.NEXT_PUBLIC_LIVEKIT_URL || wsUrl);
  }, [wsUrl]);

  return (
    <>
      <Head>
        <title>Pro-Digital Ai</title>
        <meta name="description" content="Your multimodal assistant powered by LiveKit AI agent." />
        ...
        <link rel="icon" href="/prodigital-logo.png" type="image/png" />
      </Head>
